    ...
    <div class="col-lg-9 animated fadeInRight">
        <div class="mail-box-header">
            <div class="pull-right tooltip-demo">
                <a href="{{route('compose')}}" class="btn btn-white btn-sm" data-toggle="tooltip"
            ...
            <div class="mail-tools tooltip-demo m-t-md">
                ...
                <h3>
                    <span class="font-normal">Subject: </span>Aldus PageMaker including versions of Lorem
                    Ipsum.
                </h3>
                <h5>
        ...
        <div class="mail-box">
            ...
            <div class="mail-body">
                <p>
                    ...
                    printer
                    took a galley of type and scrambled it to make a type <strong>specimen book.</strong>It
                    was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum
                    passages, and more recently with desktop publishing software like Aldus PageMaker
                    including versions of Lorem Ipsum. It has survived not only five centuries, but also the
                ...
                <p>
                    There are many variations of passages of <strong>Lorem Ipsum</strong>Lorem Ipsum
            ...
            <div class="mail-body text-right tooltip-demo">
                <a class="btn btn-sm btn-white" href="{{route('compose')}}"><i class="fa fa-reply"></i>
                    Reply</a>
                <a class="btn btn-sm btn-white" href="{{route('compose')}}"><i class="fa fa-arrow-right"></i>
                    Forward</a>
